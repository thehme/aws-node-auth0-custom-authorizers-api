...
const AUTH0_CLIENT_ID = '00OrEecALV9rciPsAELuQkjZGjfUqUhS';
const AUTH0_DOMAIN = 'dev-4xt48a2l.auth0.com';
const AUTH0_CALLBACK_URL = window.location.href; // eslint-disable-line
const PUBLIC_ENDPOINT = 'https://i9lcrps408.execute-api.us-west-2.amazonaws.com/dev/api/public';
const PRIVATE_ENDPOINT = 'https://i9lcrps408.execute-api.us-west-2.amazonaws.com/dev/api/private';
